...
\begin{itemize}
\item \textbf{solve//1}: this is called with argument \textbf{Expr}
  for user actions of the form \textbf{solve(Expr)}.

\item \textbf{actions//3}: This is called with arguments \textbf{Expr}
...
\textbf{rits:actions//3}. See \textbf{rits\_multiple\_choice} for the
definition of simple multiple choice tests that are repeated when
